...
--
-- Name: delete_accounts_payable_atomic(text, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.delete_accounts_payable_atomic(p_payable_id text, p_branch_id uuid) OWNER TO postgres;
...
--
-- Name: execute_closing_entry_atomic(uuid, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.execute_closing_entry_atomic(p_branch_id uuid, p_year integer) OWNER TO postgres;
...
ALTER FUNCTION public.get_commission_summary(p_branch_id uuid, p_date_from date, p_date_to date) OWNER TO postgres;

--
-- Name: FUNCTION get_commission_summary(p_branch_id uuid, p_date_from date, p_date_to date); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: get_expense_account_for_category(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_expense_account_for_category(category_name text) OWNER TO postgres;
...
--
-- Name: get_next_journal_number(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_next_journal_number(p_prefix text) OWNER TO postgres;
...
--
-- Name: FUNCTION get_product_stock(p_product_id uuid, p_branch_id uuid); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION get_user_branch_id(); Type: COMMENT; Schema: public; Owner: postgres
--
...
BEGIN
  ...
  --
  -- Ini mengubah "utang sistem" ΓåÆ "penjualan sah"
...
BEGIN
  ...
  IF p_consume_bom THEN
    ...
    LOOP
      ...
      -- Call with reason 'PRODUCTION'
      SELECT * INTO v_consume_result FROM consume_material_fifo(
        v_bom_item.material_id, p_branch_id, v_required_qty, v_ref, 'production', 'PRODUCTION'
      );
...
BEGIN
  ...
  -- CALL CONSUME FIFO with reason 'ADJUSTMENT'
  SELECT * INTO v_consume_result FROM consume_material_fifo(
    p_material_id, p_branch_id, p_quantity, v_ref, 'adjustment', 'ADJUSTMENT'
  );
...
--
-- Name: repay_employee_advance_atomic(uuid, text, numeric, date, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.repay_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_amount numeric, p_date date, p_payment_account_id uuid, p_recorded_by text) OWNER TO postgres;
...
--
-- Name: void_employee_advance_atomic(uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.void_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_reason text) OWNER TO postgres;
...
--
-- Name: accounts_balance_backup; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.accounts_balance_backup OWNER TO postgres;
...
--
-- Name: closing_periods closing_periods_year_branch_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_active_sessions_token; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_active_sessions_user_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_closing_periods_branch; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_closing_periods_year; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_visits_branch_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_visits_customer_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_visits_visited_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_visits_visited_by; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: deliveries trg_migration_delivery_journal; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: TRIGGER trg_migration_delivery_journal ON deliveries; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: closing_periods closing_periods_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: closing_periods closing_periods_journal_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_visits customer_visits_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: receivables receivables_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transaction_payments transaction_payments_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_visits customer_visits_allow_all; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION approve_purchase_order_atomic(p_po_id uuid, p_branch_id uuid, p_user_id uuid, p_user_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.approve_purchase_order_atomic(p_po_id uuid, p_branch_id uuid, p_user_id uuid, p_user_name text) TO authenticated;
...
--
-- Name: FUNCTION audit_trigger_func(); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.cancel_transaction_v2(p_transaction_id text, p_user_id uuid, p_user_name text, p_reason text) TO anon;
...
GRANT ALL ON FUNCTION public.check_user_permission_all(p_user_id uuid, p_permissions text[]) TO anon;
...
GRANT ALL ON FUNCTION public.check_user_permission_any(p_user_id uuid, p_permissions text[]) TO anon;
...
--
-- Name: FUNCTION consume_inventory_fifo_v3(p_product_id uuid, p_branch_id uuid, p_quantity numeric, p_reference_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.consume_inventory_fifo_v3(p_product_id uuid, p_branch_id uuid, p_quantity numeric, p_reference_id text) TO anon;
GRANT ALL ON FUNCTION public.consume_inventory_fifo_v3(p_product_id uuid, p_branch_id uuid, p_quantity numeric, p_reference_id text) TO authenticated;
...
GRANT ALL ON FUNCTION public.consume_material_fifo_v2(p_material_id uuid, p_quantity numeric, p_reference_id text, p_reference_type text, p_branch_id uuid, p_user_id uuid, p_user_name text) TO anon;
...
GRANT ALL ON FUNCTION public.create_account(p_branch_id uuid, p_name text, p_code text, p_type text, p_initial_balance numeric, p_is_payment_account boolean, p_parent_id uuid, p_level integer, p_is_header boolean, p_sort_order integer, p_employee_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_accounts_payable_atomic(p_branch_id uuid, p_supplier_name text, p_amount numeric, p_due_date date, p_description text, p_creditor_type text, p_purchase_order_id text, p_skip_journal boolean) TO anon;
...
GRANT ALL ON FUNCTION public.create_all_opening_balance_journal_rpc(p_branch_id uuid, p_opening_date date) TO anon;
...
GRANT ALL ON FUNCTION public.create_debt_journal_rpc(p_branch_id uuid, p_debt_id text, p_debt_date date, p_amount numeric, p_creditor_name text, p_creditor_type text, p_description text, p_cash_account_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_inventory_opening_balance_journal_rpc(p_branch_id uuid, p_products_value numeric, p_materials_value numeric, p_opening_date date) TO anon;
...
GRANT ALL ON FUNCTION public.create_manual_cash_in_journal_rpc(p_branch_id uuid, p_reference_id text, p_transaction_date date, p_amount numeric, p_description text, p_cash_account_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_manual_cash_out_journal_rpc(p_branch_id uuid, p_reference_id text, p_transaction_date date, p_amount numeric, p_description text, p_cash_account_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_material_payment_journal_rpc(p_branch_id uuid, p_reference_id text, p_transaction_date date, p_amount numeric, p_material_id uuid, p_material_name text, p_description text, p_cash_account_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_migration_debt_journal_rpc(p_branch_id uuid, p_debt_id text, p_debt_date date, p_amount numeric, p_creditor_name text, p_creditor_type text, p_description text) TO anon;
...
GRANT ALL ON FUNCTION public.create_migration_receivable_journal_rpc(p_branch_id uuid, p_receivable_id text, p_receivable_date date, p_amount numeric, p_customer_name text, p_description text) TO anon;
...
GRANT ALL ON FUNCTION public.create_purchase_order_atomic(p_po_header jsonb, p_po_items jsonb, p_branch_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.create_receivable_payment_journal_rpc(p_branch_id uuid, p_transaction_id text, p_payment_date date, p_amount numeric, p_customer_name text, p_payment_account_id uuid) TO anon;
...
--
-- Name: FUNCTION create_tax_payment_atomic(p_branch_id uuid, p_period text, p_ppn_masukan_used numeric, p_ppn_keluaran_paid numeric, p_payment_account_id text, p_notes text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.create_tax_payment_atomic(p_branch_id uuid, p_period text, p_ppn_masukan_used numeric, p_ppn_keluaran_paid numeric, p_payment_account_id text, p_notes text) TO authenticated;
...
GRANT ALL ON FUNCTION public.create_transfer_journal_rpc(p_branch_id uuid, p_transfer_id text, p_transfer_date date, p_amount numeric, p_from_account_id uuid, p_to_account_id uuid, p_description text) TO anon;
...
GRANT ALL ON FUNCTION public.create_zakat_payment_atomic(p_zakat jsonb, p_branch_id uuid, p_created_by uuid) TO anon;
...
--
-- Name: FUNCTION delete_accounts_payable_atomic(p_payable_id text, p_branch_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.delete_accounts_payable_atomic(p_payable_id text, p_branch_id uuid) TO authenticated;
...
GRANT ALL ON FUNCTION public.delete_po_atomic(p_po_id uuid, p_branch_id uuid, p_skip_validation boolean) TO anon;
...
GRANT ALL ON FUNCTION public.delete_zakat_record_atomic(p_branch_id uuid, p_zakat_id text) TO anon;
...
--
-- Name: FUNCTION enable_audit_for_table(target_table text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.enable_audit_for_table(target_table text) TO anon;
GRANT ALL ON FUNCTION public.enable_audit_for_table(target_table text) TO authenticated;
...
--
-- Name: FUNCTION execute_closing_entry_atomic(p_branch_id uuid, p_year integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.execute_closing_entry_atomic(p_branch_id uuid, p_year integer) TO authenticated;
...
GRANT ALL ON FUNCTION public.generate_journal_number() TO authenticated;
...
--
-- Name: FUNCTION get_commission_summary(p_branch_id uuid, p_date_from date, p_date_to date); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_commission_summary(p_branch_id uuid, p_date_from date, p_date_to date) TO authenticated;
GRANT ALL ON FUNCTION public.get_commission_summary(p_branch_id uuid, p_date_from date, p_date_to date) TO anon;
...
--
-- Name: FUNCTION get_expense_account_for_category(category_name text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_expense_account_for_category(category_name text) TO authenticated;


--
-- Name: FUNCTION get_material_fifo_cost(p_material_id uuid, p_branch_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_material_fifo_cost(p_material_id uuid, p_branch_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_material_fifo_cost(p_material_id uuid, p_branch_id uuid) TO authenticated;
...
GRANT ALL ON FUNCTION public.get_material_stock(p_material_id uuid, p_branch_id uuid) TO anon;


--
-- Name: FUNCTION get_next_journal_number(p_prefix text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_next_journal_number(p_prefix text) TO anon;
GRANT ALL ON FUNCTION public.get_next_journal_number(p_prefix text) TO authenticated;
...
GRANT ALL ON FUNCTION public.get_pending_commissions(p_employee_id uuid, p_branch_id uuid) TO anon;


--
-- Name: FUNCTION get_product_fifo_cost(p_product_id uuid, p_branch_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_product_fifo_cost(p_product_id uuid, p_branch_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_product_fifo_cost(p_product_id uuid, p_branch_id uuid) TO authenticated;
...
--
-- Name: FUNCTION get_product_weighted_avg_cost(p_product_id uuid, p_branch_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_product_weighted_avg_cost(p_product_id uuid, p_branch_id uuid) TO anon;
GRANT ALL ON FUNCTION public.get_product_weighted_avg_cost(p_product_id uuid, p_branch_id uuid) TO authenticated;


--
-- Name: FUNCTION get_record_history(p_table_name text, p_record_id text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_record_history(p_table_name text, p_record_id text) TO anon;
GRANT ALL ON FUNCTION public.get_record_history(p_table_name text, p_record_id text) TO authenticated;
...
GRANT ALL ON FUNCTION public.insert_delivery(p_transaction_id text, p_delivery_number integer, p_customer_name text, p_customer_address text, p_customer_phone text, p_delivery_date timestamp with time zone, p_photo_url text, p_notes text, p_driver_id uuid, p_helper_id uuid, p_branch_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.mark_retasi_returned_atomic(p_branch_id uuid, p_retasi_id uuid, p_return_notes text, p_item_returns jsonb) TO anon;
...
GRANT ALL ON FUNCTION public.migrate_material_stock_to_batches() TO anon;
...
GRANT ALL ON FUNCTION public.pay_commission_atomic(p_employee_id uuid, p_branch_id uuid, p_amount numeric, p_payment_date date, p_payment_method text, p_commission_ids uuid[], p_notes text, p_paid_by uuid) TO anon;
...
GRANT ALL ON FUNCTION public.post_journal_atomic(p_journal_id uuid, p_branch_id uuid) TO anon;


--
-- Name: FUNCTION prevent_posted_journal_lines_update(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.prevent_posted_journal_lines_update() TO anon;
GRANT ALL ON FUNCTION public.prevent_posted_journal_lines_update() TO authenticated;


--
-- Name: FUNCTION prevent_posted_journal_update(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.prevent_posted_journal_update() TO anon;
GRANT ALL ON FUNCTION public.prevent_posted_journal_update() TO authenticated;
...
GRANT ALL ON FUNCTION public.preview_closing_entry(p_branch_id uuid, p_year integer) TO anon;
...
GRANT ALL ON FUNCTION public.process_delivery_atomic(p_transaction_id text, p_items jsonb, p_branch_id uuid, p_driver_id uuid, p_helper_id uuid, p_delivery_date date, p_notes text, p_photo_url text) TO anon;
...
GRANT ALL ON FUNCTION public.process_laku_kantor_atomic(p_transaction_id text, p_branch_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.process_payroll_complete(p_payroll_id uuid, p_branch_id uuid, p_payment_account_id uuid, p_payment_date date) TO anon;
...
GRANT ALL ON FUNCTION public.process_retasi_atomic(p_retasi jsonb, p_items jsonb, p_branch_id uuid, p_driver_id uuid, p_driver_name text) TO anon;
...
GRANT ALL ON FUNCTION public.receive_payment_atomic(p_receivable_id text, p_branch_id uuid, p_amount numeric, p_payment_method text, p_payment_date date, p_notes text) TO anon;
...
--
-- Name: FUNCTION repay_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_amount numeric, p_date date, p_payment_account_id uuid, p_recorded_by text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.repay_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_amount numeric, p_date date, p_payment_account_id uuid, p_recorded_by text) TO authenticated;
GRANT ALL ON FUNCTION public.repay_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_amount numeric, p_date date, p_payment_account_id uuid, p_recorded_by text) TO anon;
...
GRANT ALL ON FUNCTION public.restore_material_fifo_v2(p_material_id uuid, p_quantity numeric, p_unit_cost numeric, p_reference_id text, p_reference_type text, p_branch_id uuid, p_user_id uuid, p_user_name text) TO anon;
...
GRANT ALL ON FUNCTION public.sync_attendance_checkin() TO authenticated;
...
GRANT ALL ON FUNCTION public.sync_attendance_ids() TO authenticated;
...
GRANT ALL ON FUNCTION public.sync_attendance_user_id() TO authenticated;
...
GRANT ALL ON FUNCTION public.sync_material_initial_stock_atomic(p_material_id uuid, p_branch_id uuid, p_new_initial_stock numeric, p_unit_cost numeric) TO anon;
...
GRANT ALL ON FUNCTION public.sync_product_initial_stock_atomic(p_product_id uuid, p_branch_id uuid, p_new_initial_stock numeric, p_unit_cost numeric) TO anon;
...
GRANT ALL ON FUNCTION public.update_account(p_account_id uuid, p_branch_id uuid, p_name text, p_code text, p_type text, p_initial_balance numeric, p_is_payment_account boolean, p_parent_id uuid, p_level integer, p_is_header boolean, p_is_active boolean, p_sort_order integer, p_employee_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.update_account_balance_from_journal() TO authenticated;
...
GRANT ALL ON FUNCTION public.update_account_initial_balance_atomic(p_account_id text, p_new_initial_balance numeric, p_branch_id uuid, p_user_id uuid, p_user_name text) TO anon;
...
GRANT ALL ON FUNCTION public.update_delivery_atomic(p_delivery_id uuid, p_branch_id uuid, p_items jsonb, p_driver_id uuid, p_helper_id uuid, p_delivery_date date, p_notes text, p_photo_url text) TO anon;
...
GRANT ALL ON FUNCTION public.update_payroll_record_atomic(p_payroll_id uuid, p_branch_id uuid, p_base_salary numeric, p_commission numeric, p_bonus numeric, p_advance_deduction numeric, p_salary_deduction numeric, p_notes text) TO anon;
...
GRANT ALL ON FUNCTION public.update_transaction_atomic(p_transaction_id text, p_transaction jsonb, p_branch_id uuid, p_user_id uuid, p_user_name text) TO anon;
...
GRANT ALL ON FUNCTION public.validate_branch_access(p_user_id uuid, p_branch_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.validate_journal_entry(p_journal_id uuid) TO authenticated;
...
GRANT ALL ON FUNCTION public.void_closing_entry_atomic(p_branch_id uuid, p_year integer) TO anon;
...
--
-- Name: FUNCTION void_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_reason text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.void_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_reason text) TO authenticated;
GRANT ALL ON FUNCTION public.void_employee_advance_atomic(p_branch_id uuid, p_advance_id text, p_reason text) TO anon;
...
GRANT ALL ON FUNCTION public.void_journal_by_reference(p_reference_id text, p_reference_type text, p_user_id uuid, p_user_name text, p_reason text) TO anon;
...
GRANT ALL ON FUNCTION public.void_journal_entry(p_journal_id uuid, p_branch_id uuid, p_reason text) TO anon;
...
GRANT ALL ON FUNCTION public.void_production_atomic(p_production_id uuid, p_branch_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.void_retasi_atomic(p_retasi_id uuid, p_branch_id uuid, p_reason text, p_user_id uuid) TO anon;
...
GRANT ALL ON FUNCTION public.void_zakat_payment_atomic(p_zakat_id uuid, p_branch_id uuid, p_reason text, p_user_id uuid) TO anon;
...
--
-- Name: TABLE accounts_balance_backup; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.accounts_balance_backup TO anon;
GRANT ALL ON TABLE public.accounts_balance_backup TO authenticated;
...
--
-- Name: TABLE closing_periods; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE customer_visits; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.customer_visits TO anon;
GRANT ALL ON TABLE public.customer_visits TO authenticated;
...
--
-- Name: TABLE v_audit_summary; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.v_audit_summary TO anon;
GRANT ALL ON TABLE public.v_audit_summary TO authenticated;
...
GRANT ALL ON TABLE public.v_inventory_batches_detail TO anon;
GRANT ALL ON TABLE public.v_inventory_batches_detail TO authenticated;
...
GRANT ALL ON TABLE public.v_material_current_stock TO anon;
GRANT ALL ON TABLE public.v_material_current_stock TO authenticated;
...
GRANT ALL ON TABLE public.v_product_current_stock TO anon;
GRANT ALL ON TABLE public.v_product_current_stock TO authenticated;
...
GRANT ALL ON TABLE public.v_stock_mismatches TO anon;
GRANT ALL ON TABLE public.v_stock_mismatches TO authenticated;
...
\unrestrict MOVBtL0PHXYKK5aU7KI4WvJwc9TetAbUQFL62CFgQi0qtT2TlFVWDrCREqK4TFk
