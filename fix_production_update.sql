-- ============================================================================
-- RPC 04: Production Atomic (UPDATED v2)
-- Fix: Change account ID variables to TEXT (accounts table uses TEXT id)
-- ============================================================================
...
DECLARE
  ...
  v_journal_id UUID;
  v_entry_number TEXT;
  v_persediaan_barang_id TEXT; -- FIX: Changed to TEXT
  v_persediaan_bahan_id TEXT;  -- FIX: Changed to TEXT
  v_unit_cost NUMERIC;
...
DECLARE
  ...
  v_journal_id UUID;
  v_entry_number TEXT;
  v_beban_lain_id TEXT;         -- FIX: Changed to TEXT
  v_persediaan_bahan_id TEXT;   -- FIX: Changed to TEXT
BEGIN
  -- ==================== VALIDASI ====================
