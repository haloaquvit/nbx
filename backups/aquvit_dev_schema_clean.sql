...
\restrict xnTZgBBc91uJRTHWNPmM96rQZdBjs8S5vfpgShQQZCs3VAgm5yUw5qeR0J2TLUz
...
--
-- Name: process_delivery_atomic_no_stock(text, jsonb, uuid, uuid, uuid, timestamp with time zone, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.process_delivery_atomic_no_stock(p_transaction_id text, p_items jsonb, p_branch_id uuid, p_driver_id uuid DEFAULT NULL::uuid, p_helper_id uuid DEFAULT NULL::uuid, p_delivery_date timestamp with time zone DEFAULT now(), p_notes text DEFAULT NULL::text, p_photo_url text DEFAULT NULL::text) RETURNS TABLE(success boolean, delivery_id uuid, delivery_number integer, total_hpp numeric, journal_id uuid, error_message text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_delivery_id UUID;
...
--
-- Name: update_delivery_atomic(uuid, uuid, jsonb, uuid, uuid, timestamp with time zone, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_delivery_atomic(p_delivery_id uuid, p_branch_id uuid, p_items jsonb, p_driver_id uuid DEFAULT NULL::uuid, p_helper_id uuid DEFAULT NULL::uuid, p_delivery_date timestamp with time zone DEFAULT now(), p_notes text DEFAULT NULL::text, p_photo_url text DEFAULT NULL::text) RETURNS TABLE(success boolean, delivery_id uuid, total_hpp numeric, journal_id uuid, error_message text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_delivery RECORD;
...
\unrestrict xnTZgBBc91uJRTHWNPmM96rQZdBjs8S5vfpgShQQZCs3VAgm5yUw5qeR0J2TLUz
