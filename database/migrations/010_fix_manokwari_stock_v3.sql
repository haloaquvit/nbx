-- Migration 010 v3: Fix Manokwari Stock and Inventory Journal
-- Purpose: Create stock adjustment journals for existing stock
-- Run this on Manokwari database ONLY
-- Date: 2026-01-04
-- Fixed: Use 'adjustment' reference_type (allowed by constraint)

-- Note: Inventory batches already created in v2, this only creates journals
...
-- Uses 'adjustment' as reference_type (allowed by constraint)
-- ============================================================================
DO $$
DECLARE
  v_product RECORD;
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO journal_entries (
      ...
      'adjustment',  -- Use 'adjustment' (allowed by constraint)
      v_product.id::text,
      'posted',
      false,
      v_branch_id,
