...
CREATE INDEX IF NOT EXISTS idx_customers_created_at ON public.customers("createdAt");
...
CREATE INDEX IF NOT EXISTS idx_accounts_is_payment_account ON public.accounts(is_payment_account);
